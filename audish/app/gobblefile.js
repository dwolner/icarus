...
var components = gobble([
	gobble('components/partials'),
	gobble('components').exclude('partials/*')
]);
...
var bundle = gobble([componentsjs, register])
	.transform('rollup', {
	  entry: 'components.js',
	...
	.transform( 'uglifyjs', {sourceMap: false} );
