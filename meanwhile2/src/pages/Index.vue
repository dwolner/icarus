<template>
  <q-page class="">
      ...
      <div class="bg-black" style="padding: 1rem;">
          ...
          <div id="videoSection" align="center" style="margin: 2rem 0;">
              <div class="row">
                  <q-btn><h6 class="text-white" style="margin: 0;">#{{selectedTag}}</h6></q-btn>
                  <q-btn v-for="tag in allTags" v-if="tag !== selectedTag" @click="selectTag(tag)"><h6 class="text-grey" style="margin: 0;">#{{tag}}</h6></q-btn>
              </div>
                 ...
                 >
                    ...
                    <div class="centerHeaderHold">
                        <div class="centerHeader">
                            <h6 class="text-white" style="margin: 0;">{{item.title}}</h6>
